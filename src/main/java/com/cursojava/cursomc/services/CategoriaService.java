...
import com.cursojava.cursomc.dto.CategoriaDTO;
...
public class CategoriaService {
	...
	//Definir uma página com a quantidade de registros configurados via parâmetro.
	public Page<Categoria> findPage(Integer page, Integer linesPerPage, String orderBy, String direction){
		PageRequest pageRequest = PageRequest.of(page, linesPerPage, Direction.valueOf(direction), orderBy);
		return repo.findAll(pageRequest);
	}
	
	//Transformando uma CategoriaDTO em Categoria:
	public Categoria fromDTO(CategoriaDTO dtoObject) {
		return new Categoria(dtoObject.getId(), dtoObject.getNome());
	}
}
